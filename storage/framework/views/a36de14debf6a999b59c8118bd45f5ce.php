...
<footer class="bg-dark text-light pt-5 pb-4 mt-5 footer-custom">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                ...
                <ul class="list-unstyled">
                    <li><a href="<?php echo e(route('welcome')); ?>" class="text-decoration-none text-secondary">Home</a></li>
        ...
        <div class="text-center">
            © <?php echo e(date('Y')); ?> <strong>Hotelak</strong>. All Rights Reserved.
        </div>
    </div>
</footer>
<?php /**PATH C:\xampp\htdocs\Hotel_Booking\booking\resources\views/layouts/footer.blade.php ENDPATH**/ ?>